...
def create_desktop_file(app_name, exec_path = "/home/rapa/git/pipeline/login.py", icon_path="/home/rapa/git/pipeline/sourceimages/moominlogo.png"):
    """
...
Type=Application
Name=MoominsLogin
Exec=/usr/bin/python3.9 /home/rapa/git/pipeline/login.py
Terminal=false
